...
namespace TicTacToeGameLogic
{
    public class Game
    {
        ...
        internal Player m_Player1 { get; set; }
        internal Player m_Player2 { get; set; }
            ...
            ePlayerType i_Player2Type)
        {
            ...
            m_Player1 = new Player(eCell.P2, i_Player2Name, i_Player2Type);
            initPlayersArr();
            onGameStarted();
            onBoardUpdated();
        }
        ...
        private void updateEndGame()
        {
            if (CheckTie(m_Board))
            {
                m_FinishGameType = eFinishGameType.Tie;
                m_PlayersArr[0].m_Points++;
                m_PlayersArr[1].m_Points++;
            }
            else
            {
                SwitchPlayer();
                m_PlayersArr[m_CurrPlayerIndex].m_Points++;
                if (!m_FinishGameType.Equals(eFinishGameType.Quit))
                {
                    m_FinishGameType = eFinishGameType.Win;
                }
            }
